                ...
                <div class="pricing-table purple border card">
                    <div class="card-body">
                        ...
                        <div class="price-tag">
                            ...
                            <span class="amount ">{{ number_format(floatval($plan->price)) }}</span>
                        </div>
                        <!-- Features -->
                        <div class="pricing-features">
                            <div class="feature text-dark">Minimum Possible Deposit:<span
                                    class="">{{ $settings->currency }}{{ number_format(floatval($plan->min_price)) }}</span>
                            </div>
                            <div class="feature text-dark">Maximum Possible Deposit:<span
                                    class="">{{ $settings->currency }}{{ number_format(floatval($plan->max_price)) }}</span>
                            </div>
                            <div class="feature text-dark">Minimum Return:<span
                                    class="">{{ number_format(floatval($plan->minr)) }}%</span></div>
                            <div class="feature text-dark">Maximum Return:<span
                                    class="">{{ number_format(floatval($plan->maxr)) }}%</span></div>
