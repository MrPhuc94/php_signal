                                ...
                                <form method="post" wire:submit.prevent='saveFixed'>
                                    ...
                                    <div class="form-group">
                                        <div class="alert alert-info" role="alert">
                                            Our Copytrade feature is powered by <a
                                                href="https://metaapi.cloud/">{{ strtoupper('metaapi') }}</a>, a
                                            Powerful,
                                            reliable, fast, scalable, cost-efficient, easy to use and standards-driven
                                            websocket API. We usually manage all
                                            of the accounts for you, but you can manage your accounts yourself. Click on
                                            "Use My MetaApi Account" to ge
                                            started.
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-check-label">
                                            <input type="checkbox" wire:model='use_my_metaapi_account'>
                                            <span class="form-check-sign">Use My MetaApi Account</span>
                                        </label>
                                    </div>
                                    @if ($use_my_metaapi_account)
                                        <div class="form-group">
