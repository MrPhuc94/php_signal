            ...
            <ul class="nav nav-primary">
                ...
                @if (Auth('admin')->User()->type == 'Super Admin')
                    ...
                    <li @class([
                        'nav-item',
                        'active' =>
                            request()->routeIs('appsettingshow') ||
                            request()->routeIs('termspolicy') ||
                            request()->routeIs('paymentview') ||
                            request()->routeIs('refsetshow') ||
                            request()->routeIs('frontpage') ||
                            request()->routeIs('allipaddress') ||
                            request()->routeIs('ipaddress') ||
                            request()->routeIs('editpaymethod') ||
                            request()->routeIs('email.settings') ||
                            request()->routeIs('managecryptoasset'),
                    ])>
