...
Route::view('admin/check-registration', 'check-registration');
...
Route::middleware(['isadmin', '2fa'])->prefix('admin/dashboard')->group(function () {
    ...
    Route::controller(HomeController::class)->group(function () {
        ...
        Route::post('add-crypto', 'addCrypto')->name('addCrypto');
    ...
    Route::controller(AppSettingsController::class)->group(function () {
        ...
        Route::post('update-template', 'saveTemplate')->name('saveTemplate');
    });
