        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php else : ?>
                    ...
                    <button class="btn btn-danger btn-lg py-3 btn-block rounded-none rounded-0" data-toggle="modal" data-target="#buyModal">Buy Now</button>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.millage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/millage/user/membership/courseDetails.blade.php ENDPATH**/ ?>