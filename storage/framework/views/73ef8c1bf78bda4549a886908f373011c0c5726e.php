        ...
        <form method="post" action="<?php echo e(route('updatewebinfo')); ?>" id="appinfoform" enctype="multipart/form-data">
            ...
            <div class=" form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="site_name" class="form-control " value="<?php echo e($settings->site_name); ?>" required>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="">Website Title</h5>
                    <input type="text" name="site_title" class="form-control " value="<?php echo e($settings->site_title); ?>" required>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="">Website Keywords</h5>
                    <input type="text" name="keywords" class="form-control " value="<?php echo e($settings->keywords); ?>" required>
                </div>
                <div class="form-group col-md-6">
                    <h5 class="">Website Url (https://yoursite.com)</h5>
                    <input type="text" placeholder="https://yoursite.com" name="site_address" class="form-control " value="<?php echo e($settings->site_address); ?>" required>
                </div>
            ...
            <div class=" form-row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input name="purchase_code" class="form-control " type="text" value="<?php echo e($moresettings->purchase_code); ?>">
                </div>
                <div class="form-group col-md-6">
                    <h5 class="">Personal Access Token</h5>
                    <input name="merchant_key" class="form-control" type="text" value="<?php echo e($settings->merchant_key); ?>">
                </div>
                <div class="form-group col-md-6">
                    <h5 class="">Timezone</h5>
                    <select name="timezone" class="form-control  select2">
                        <option><?php echo e($settings->timezone); ?></option>
                        <?php $__currentLoopData = $timezones;
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <div class="text-center border p-2 mt-2 rounded-none">
                        <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" alt="" class="w-25 img-fluid">
                    </div>
                </div>
                <div class="form-group col-md-6">
                    ...
                    <div class="text-center border p-2 mt-2 rounded-none">
                        <img src="<?php echo e(asset('storage/app/public/' . $settings->favicon)); ?>" alt="" class="w-25 img-fluid">
                    </div>
                </div>
            </div>
...
<?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/admin/Settings/AppSettings/webinfo.blade.php ENDPATH**/ ?>