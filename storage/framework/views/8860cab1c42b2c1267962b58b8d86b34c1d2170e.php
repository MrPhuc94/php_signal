                                        ...
                                        <?php if ($settings->deposit_option != 'manual') : ?>
                                            <?php if (
                                                ...
                                                <?php if (
                                                    ...
                                                    } elseif ($_instance->childHasBeenRendered('cn9clJt')) {
                                                        $componentId = $_instance->getRenderedChildComponentId('cn9clJt');
                                                        $componentTag = $_instance->getRenderedChildComponentTagName('cn9clJt');
                                                        $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                                        $_instance->preserveRenderedChild('cn9clJt');
                                                    } else {
                                                        $response = \Livewire\Livewire::mount('user.crypto-payment', []);
                                                        $html = $response->html();
                                                        $_instance->logRenderedChild('cn9clJt', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                                                    }
                                                    echo $html;
                                                    ?>
                                                <?php else : ?>
                                                    <a href="<?php echo e(url('dashboard/cpay')); ?>/<?php echo e($amount); ?>/<?php echo e($coin); ?>/<?php echo e(Auth::user()->id); ?>/new" class="btn btn-primary">Pay Via Coinpayment</a>
                                                <?php endif; ?>
                                            <?php else : ?>
                                                <?php if ((!empty($payment_mode->barcode) or $payment_mode->barcode != null) and $payment_mode->methodtype != 'currency') : ?>
                                                    <div class="text-center">
                                                        <img src="<?php echo e(asset('storage/app/public/' . $payment_mode->barcode)); ?>" alt="" class="w-50">
                                                    </div>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        <?php if ($payment_mode->methodtype != 'currency') : ?>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <div class="mb-3 form-group">
                                                    <input type="text" class="form-control readonly" value="<?php echo e($payment_mode->wallet_address); ?>" readonly>
                                                ...
                                                <?php if ($payment_mode->name == 'Credit Card' and $settings->credit_card_provider == 'Flutterwave') : ?>
                                                    <div>
                                                        <form method="POST" action="<?php echo e(route('paybyflutterwave')); ?>">
                                                            ...
                                                            <input name="phone" type="hidden" value="<?php echo e(Auth::user()->phone); ?>" />
                                                ...
                                                <?php if ($payment_mode->name == 'Bank Transfer') : ?>
                                                    <?php if (!empty($payment_mode->bankname)) : ?>
                                                        ...
                                                        <div class="mb-3 input-group">
                                                            <input type="text" class="form-control readonly " value="<?php echo e($payment_mode->bankname); ?>" readonly>
                                                    ...
                                                    <?php if (!empty($payment_mode->account_name)) : ?>
                                                        ...
                                                        <div class="mb-3 input-group">
                                                            <input type="text" class="form-control readonly " value="<?php echo e($payment_mode->account_name); ?>" readonly>
                                                            <div class="input-group-append">
                                                                <button class="btn btn-outline-secondary" onclick="myFunction()" type="button" id="button-addon2" disabled><i class="fas fa-copy"></i></button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php if (!empty($payment_mode->account_number)) : ?>
                                                        ...
                                                        <div class="mb-3 input-group">
                                                            <input type="text" class="form-control readonly " value="<?php echo e($payment_mode->account_number); ?>" readonly>
                                                            <div class="input-group-append">
                                                                <button class="btn btn-outline-secondary" onclick="myFunction()" type="button" id="button-addon2" disabled><i class="fas fa-copy"></i></button>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <?php if (!empty($payment_mode->swift_code)) : ?>
                                                        ...
                                                        <div class="mb-3 input-group">
                                                            <input type="text" class="form-control readonly " value="<?php echo e($payment_mode->swift_code); ?>" readonly>
                                                            <div class="input-group-append">
                                                                <button class="btn btn-outline-secondary" onclick="myFunction()" type="button" id="button-addon2" disabled><i class="fas fa-copy"></i></button>
                                                            </div>
                                                        </div>
...
<?php echo $__env->make('layouts.millage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/millage/user/payment.blade.php ENDPATH**/ ?>