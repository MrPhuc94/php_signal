...
} elseif ($_instance->childHasBeenRendered('ilmciNe')) {
    $componentId = $_instance->getRenderedChildComponentId('ilmciNe');
    $componentTag = $_instance->getRenderedChildComponentTagName('ilmciNe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ilmciNe');
} else {
    $response = \Livewire\Livewire::mount('admin.software-module', []);
    $html = $response->html();
    $_instance->logRenderedChild('ilmciNe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/admin/Settings/AppSettings/show.blade.php ENDPATH**/ ?>