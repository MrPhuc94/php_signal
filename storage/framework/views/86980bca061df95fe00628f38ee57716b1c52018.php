...
} elseif ($_instance->childHasBeenRendered('l3657343086-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l3657343086-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l3657343086-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l3657343086-0');
} else {
    $response = \Livewire\Livewire::mount('admin.buy-slot', []);
    $html = $response->html();
    $_instance->logRenderedChild('l3657343086-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 col-stats">
                            <div class="numbers">
                                ...
                                <h2><?php echo e($subscribers['data'] ? count($subscribers['data']) : '0'); ?></h2>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/admin/subscription/master/statistics.blade.php ENDPATH**/ ?>