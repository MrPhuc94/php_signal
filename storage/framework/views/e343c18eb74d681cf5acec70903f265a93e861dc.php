        ...
        <div class="pb-3 row justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                <div class="text-center">
                    <a href="/">
                        <img src="<?php echo e(asset('storage/app/public/' . $settings->logo)); ?>" alt="" class="mb-3 img-fluid auth__logo">
                    </a>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <p class="mb-0 forgot-pass"><a href="<?php echo e(route('admin.forgetpassword')); ?>" class="text-dark font-weight-bold">Forgot password ?</a></p>
                                    </div>
                                </div>
                                <!--end col-->
...
<?php echo $__env->make('layouts.guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/auth/adminlogin.blade.php ENDPATH**/ ?>