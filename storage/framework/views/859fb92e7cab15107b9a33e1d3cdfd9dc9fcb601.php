        ...
        <div class="form-row">
            ...
            <div class="col-12">
                ...
                <?php if(session()->has('success-message')): ?>
                    <small class="text-success d-block mt-2"> <?php echo e(session('success-message')); ?></small>
                <?php endif; ?>
            </div>
        </div>
    </form>
</div>
<?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/livewire/admin/platform/production-setup.blade.php ENDPATH**/ ?>