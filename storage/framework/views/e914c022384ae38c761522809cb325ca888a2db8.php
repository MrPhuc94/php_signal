                                        ...
                                        <?php if ($settings->deposit_option != 'manual') : ?>
                                            <?php if (
                                                ...
                                                <?php if (
                                                    ...
                                                    } elseif ($_instance->childHasBeenRendered('x6akDI0')) {
                                                        $componentId = $_instance->getRenderedChildComponentId('x6akDI0');
                                                        $componentTag = $_instance->getRenderedChildComponentTagName('x6akDI0');
                                                        $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
                                                        $_instance->preserveRenderedChild('x6akDI0');
                                                    } else {
                                                        $response = \Livewire\Livewire::mount('user.crypto-payment', []);
                                                        $html = $response->html();
                                                        $_instance->logRenderedChild('x6akDI0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
                                                    }
                                                    echo $html;
                                                    ?>
                                                <?php else : ?>
...
<?php echo $__env->make('layouts.dash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Documents/Brynamics/OnlineTrader/onlinetrade/resources/views/purpose/user/payment.blade.php ENDPATH**/ ?>